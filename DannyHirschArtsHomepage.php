...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="DannyHirschArtsHomepage.css?v=20260724-gallery-32">
    <link rel="stylesheet" href="DannyHirschArtsCinematic.css?v=20260724-gallery-32">
  ...
  <body data-theme="dark" class="opening-pending">
    ...
    <dialog class="room-experience" data-room-experience aria-labelledby="room-experience-title" aria-describedby="room-experience-description">
      <div class="room-experience__stage" data-room-experience-stage>
        ...
        <nav class="room-experience__demo-nav room-experience__sidebar" data-gallery-demo-nav aria-label="Navigate the 3D exhibition" hidden>
          ...
          <div class="room-experience__sidebar-scroll">
            <p>Rooms</p>
    ...
    <script src="DannyHirschArtsHomepage.js?v=20260724-gallery-32" defer></script>
  </body>
</html>
