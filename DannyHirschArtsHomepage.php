...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="DannyHirschArtsHomepage.css?v=20260729-performance-01">
    <link rel="stylesheet" href="DannyHirschArtsCinematic.css?v=20260729-performance-01">
  ...
  <body data-theme="dark" class="opening-pending">
    ...
    <script src="DannyHirschArtsLoungeAudio.js?v=20260729-performance-01" defer></script>
    <script src="DannyHirschArtsHomepage.js?v=20260729-performance-01" defer></script>
  </body>
</html>
