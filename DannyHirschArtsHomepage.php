...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="DannyHirschArtsHomepage.css?v=20260728-memory-02">
    <link rel="stylesheet" href="DannyHirschArtsCinematic.css?v=20260728-memory-02">
  ...
  <body data-theme="dark" class="opening-pending">
      ...
      <div class="room-experience__stage" data-room-experience-stage>
        ...
        <nav class="room-experience__demo-nav room-experience__sidebar" data-gallery-demo-nav aria-label="Navigate the 3D exhibition" hidden>
          ...
          <div class="room-experience__sidebar-scroll" id="gallery-spatial-navigation">
            ...
            <button type="button" data-index="02" data-gallery-demo-room="private-room">Private Room</button>
            <button type="button" data-index="03" data-gallery-demo-room="contact-room">Meet &amp; Contact</button>
            <p>Explore</p>
            <button type="button" data-index="04" data-gallery-demo-art>Artwork Index</button>
            <button type="button" data-index="05" data-gallery-demo-panel="about">About</button>
            <button type="button" data-index="06" data-gallery-demo-panel="process">Process</button>
            <button type="button" data-index="07" data-gallery-demo-panel="inquiry">Inquiry</button>
            <p>Legal</p>
            <button type="button" data-index="08" data-gallery-demo-panel="privacy">Privacy</button>
            <button type="button" data-index="09" data-gallery-demo-panel="imprint">Imprint</button>
          </div>
        </nav>
        ...
        <div class="room-experience__memory-status" data-gallery-memory-status aria-live="polite" hidden>
          <span aria-hidden="true"></span><p>The room remembers <b data-gallery-memory-count>0 / 3</b></p>
        </div>
    ...
    <script src="DannyHirschArtsLoungeAudio.js?v=20260728-memory-02" defer></script>
    <script src="DannyHirschArtsHomepage.js?v=20260728-memory-02" defer></script>
  </body>
</html>
