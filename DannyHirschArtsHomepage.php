...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="DannyHirschArtsHomepage.css?v=20260723-gallery-30">
    <link rel="stylesheet" href="DannyHirschArtsCinematic.css?v=20260723-gallery-30">
  ...
  <body data-theme="dark" class="opening-pending">
    ...
    <dialog class="room-experience" data-room-experience aria-labelledby="room-experience-title" aria-describedby="room-experience-description">
      <div class="room-experience__stage" data-room-experience-stage>
        ...
        <nav class="room-experience__demo-nav" data-gallery-demo-nav aria-label="3D website rooms" hidden>
          <span>Room tour</span>
          <button type="button" data-gallery-demo-room="gallery-hall">Gallery hall</button>
          <button type="button" data-gallery-demo-room="private-room">Private room</button>
          <button type="button" data-gallery-demo-room="contact-room">Meet &amp; contact</button>
    ...
    <script src="DannyHirschArtsHomepage.js?v=20260723-gallery-30" defer></script>
  </body>
</html>
