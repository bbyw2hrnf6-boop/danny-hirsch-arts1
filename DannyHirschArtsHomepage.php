...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="DannyHirschArtsHomepage.css?v=20260729-room-ux-02">
    <link rel="stylesheet" href="DannyHirschArtsCinematic.css?v=20260729-room-ux-02">
  ...
  <body data-theme="dark" class="opening-pending">
    ...
    <header class="site-header" aria-label="Site header">
      ...
      <div class="site-controls" aria-label="Display and sound controls">
        <button class="spatial-toggle" type="button" data-open-spatial aria-label="Open the interactive 3D exhibition">
          <span class="control-glyph spatial-glyph" aria-hidden="true"><i></i></span>
          <span class="control-label">3D Gallery</span>
        </button>
    ...
    <section class="experience-choice" data-experience-choice role="dialog" aria-modal="true" aria-labelledby="experience-choice-title" aria-describedby="experience-choice-description" hidden>
      <div class="experience-choice__atmosphere" aria-hidden="true"><span></span><i></i></div>
      <div class="experience-choice__shell">
        <header class="experience-choice__heading">
          <p>The threshold is open</p>
          <h2 id="experience-choice-title">Choose how<br>you enter.</h2>
          <span id="experience-choice-description">Follow the editorial exhibition, or step directly into the walkable 3D gallery.</span>
        </header>
        <div class="experience-choice__options" role="group" aria-label="Choose an exhibition experience">
          <button class="experience-choice__option experience-choice__option--classic" type="button" data-experience-classic aria-describedby="experience-classic-description">
            <span class="experience-choice__number" aria-hidden="true">01</span>
            <span class="experience-choice__option-copy">
              <small>Curated scroll</small>
              <strong>Classic site</strong>
              <span id="experience-classic-description">Artwork chapters, surfaces, process, and inquiry in a refined editorial journey.</span>
            </span>
            <i aria-hidden="true">Enter site&nbsp; ↘</i>
          </button>
          <button class="experience-choice__option experience-choice__option--spatial" type="button" data-experience-3d aria-describedby="experience-spatial-description">
            <span class="experience-choice__number" aria-hidden="true">02</span>
            <span class="experience-choice__option-copy">
              <small>Walkable exhibition</small>
              <strong>Interactive 3D Gallery</strong>
              <span id="experience-spatial-description">Move through the Blender-built rooms and approach genuine artwork photography in space.</span>
            </span>
            <i aria-hidden="true">Enter gallery&nbsp; ↗</i>
          </button>
        </div>
        <p class="experience-choice__note">The classic site still includes the curated Private Room.</p>
      </div>
    </section>
      ...
      <div class="room-experience__stage" data-room-experience-stage>
        ...
        <header class="room-experience__header">
          ...
          <div class="room-experience__header-actions">
            <button class="room-experience__view-switch" type="button" data-room-classic aria-label="Switch to the classic website">
              <span aria-hidden="true">↙</span><b>Classic site</b>
            </button>
            <button class="room-experience__fullscreen" type="button" data-room-fullscreen aria-label="Enter full screen" aria-pressed="false">
              <span aria-hidden="true"><i></i><i></i><i></i><i></i></span><b>Full screen</b>
            </button>
        ...
        <p class="room-experience__description" id="room-experience-description">Drag to look around. Use W A S D, arrow keys, or the movement controls to walk. Scroll or press + / − to adjust your view. The room is a Blender-built spatial interpretation using genuine artwork photography.</p>

        <aside class="room-experience__art" data-gallery-art-card data-proximity="ambient" aria-live="polite">
          <figure class="room-experience__art-media">
            <img src="assets/cinematic/threshold-room-center.webp" alt="" data-gallery-art-image width="1800" height="1125" decoding="async">
            <div class="room-experience__surface-lens" data-gallery-surface-lens-view hidden aria-hidden="true">
              <img src="assets/cinematic/threshold-room-center.webp" alt="" data-gallery-lens-image decoding="async">
              <span aria-hidden="true"></span>
              <small>Genuine macro · relief interpretation</small>
            </div>
            <figcaption>
              <span data-gallery-art-proximity>Free look</span>
              <output data-gallery-zoom aria-label="Gallery zoom level">100%</output>
            </figcaption>
          </figure>
          <div class="room-experience__art-copy">
            <div class="room-experience__art-overline">
              <p data-gallery-art-kicker>Spatial gallery</p>
              <span data-gallery-art-index aria-hidden="true">Room view</span>
            </div>
            <strong data-gallery-art-title>Move through the gallery</strong>
            <span class="room-experience__art-detail" data-gallery-art-detail>Turn toward a surface. The dossier will respond when a genuine work enters your view.</span>
            ...
            <div class="room-experience__scale" data-gallery-scale hidden aria-label="Artwork scale reference">
              <span aria-hidden="true"><i></i></span><small data-gallery-scale-copy>Catalogue scale</small>
            </div>
            <div class="room-experience__art-action">
              <button type="button" data-gallery-art-inspect disabled><span>View artwork</span><i aria-hidden="true">↗</i></button>
              <button type="button" data-gallery-surface-lens aria-pressed="false" disabled><span>Surface lens</span><i aria-hidden="true">◎</i></button>
              <small><kbd>Scroll</kbd> to move closer</small>
            </div>
          </div>
        </aside>
        ...
        <aside class="room-experience__site-panel" data-gallery-site-panel aria-live="polite" hidden>
          ...
          <p data-gallery-site-kicker>Spatial exhibition</p>
        ...
        <nav class="room-experience__demo-nav room-experience__sidebar" data-gallery-demo-nav aria-label="Navigate the 3D exhibition" hidden>
          <header class="room-experience__sidebar-heading">
            <span>Spatial map</span>
            <small>Choose a room or story</small>
            <button class="room-experience__sidebar-toggle" type="button" data-gallery-sidebar-toggle aria-expanded="true" aria-controls="gallery-spatial-navigation">
              <i aria-hidden="true"><span></span><span></span><span></span></i><b>Map</b>
            </button>
          </header>
          <div class="room-experience__sidebar-scroll" id="gallery-spatial-navigation">
            <p>Rooms</p>
            <button type="button" data-index="01" data-gallery-demo-room="gallery-hall">Gallery Hall</button>
            <button type="button" data-index="02" data-gallery-demo-room="private-room">Privacy Room</button>
            <button type="button" data-index="03" data-gallery-demo-room="contact-room">Info &amp; Contact</button>
            <p>Explore</p>
            <button type="button" data-index="04" data-gallery-demo-art>Artwork Index</button>
            <button type="button" data-index="05" data-gallery-demo-panel="about">About Artist</button>
            <button type="button" data-index="06" data-gallery-demo-panel="process">Making the Art</button>
            <button type="button" data-index="07" data-gallery-demo-panel="inquiry">Contact Artist</button>
            <p>Site information</p>
            <button type="button" data-index="08" data-gallery-demo-panel="privacy">Privacy</button>
          </div>
        </nav>

        <div class="room-experience__walk-controls" data-gallery-controls aria-label="Walkable gallery controls" hidden>
          <div class="room-experience__dpad" data-gallery-joystick="move" role="group" aria-label="Movement joystick">
            ...
            <span class="room-experience__stick-ring" aria-hidden="true"></span>
            <span class="room-experience__stick-knob" aria-hidden="true"></span>
            <span class="room-experience__stick-label" aria-hidden="true">Move</span>
          </div>
          <div class="room-experience__look-stick" data-gallery-joystick="look" role="group" aria-label="Look joystick">
            <button type="button" data-gallery-look-control aria-label="Drag to look around the gallery">
              <span class="room-experience__stick-ring" aria-hidden="true"></span>
              <span class="room-experience__stick-knob" aria-hidden="true"></span>
            </button>
            <span class="room-experience__stick-label" aria-hidden="true">Look</span>
          </div>
          <button class="room-experience__motion-look" type="button" data-gallery-motion-look aria-label="Enable motion look using phone movement" aria-pressed="false">
            <span class="room-experience__motion-icon" aria-hidden="true"><i></i></span>
            <span><b>Motion look</b><small>Use phone movement</small></span>
          </button>
          <div class="room-experience__tour" role="group" aria-label="Curated artwork views">
            ...
            <button type="button" data-gallery-guided aria-pressed="false" aria-label="Start guided exhibition">Guided exhibition</button>
          </div>
        </div>

        <div class="room-experience__transition" data-gallery-transition aria-hidden="true">
          <i></i><i></i><span data-gallery-transition-label>Passing through material</span>
        </div>
    ...
    <script src="DannyHirschArtsLoungeAudio.js?v=20260729-room-ux-02" defer></script>
    <script src="DannyHirschArtsHomepage.js?v=20260729-room-ux-02" defer></script>
  </body>
</html>
